...
See [New Students](new-students.md) for further information.
...
- Culminating experience (3 units): ENGL 698D (Capstone), ENGL 697C (Exam) [permission number required; can only be taken in the final two semesters after certain [pre-requisites](../engl698D.md) have been completed.
...
**ENGL 698D Graduate Project Course (available to students in all three options; can only be taken in the final two semesters after certain [pre-requisites](../engl698D.md) have been completed).**
