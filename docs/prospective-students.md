...
The CSUN English Department's MA program has three options: Creative Writing, Literature, and Rhetoric & Composition. Regardless of which option you choose, the official degree you receive will be an MA in English. For further details about the program, see the [About page](about.md).
...
CSUN does not offer financial aid to international students. For available funding opportunities, see [https://www.csun.edu/financialaid/special-groups/international-students](https://www.csun.edu/financialaid/special-groups/international-students){target="_blank"}.

## How to Apply

### Deadlines

| Starting Semester | Deadline for Applications |
| ----------------- | ------------------------- |
| Spring 2027       | November 1, 2026          |
| Fall 2027         | June 1, 2027              |
