...
### ENGL 507 Introduction to Graduate Studies -- Underwood ([Flyer](../assets/flyers/ENGL507.pdf){target="_blank"})
...
### ENGL 512 Writing for Performance -- Mitchell ([Flyer](../assets/flyers/ENGL512.pdf){target="_blank"})
...
### ENGL 525AGL Avant Garde Literature -- Higgs ([Flyer](../assets/flyers/ENGL525AGL.pdf){target="_blank"})
...
### ENGL 630TTT Twice-Told Tales -- Byler ([Flyer](../assets/flyers/ENGL630TTT.pdf){target="_blank"})
...
### ENGL 654 Advanced Rhetoric and Composition -- Khadka ([Flyer](../assets/flyers/ENGL654.pdf){target="_blank"})
